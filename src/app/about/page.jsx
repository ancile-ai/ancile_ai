        ...
        <div className="relative mx-auto max-w-4xl px-4 py-24 text-center sm:px-6 lg:px-8">
          <Reveal>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              ...
              constraints, deployment realities, and execution discipline matter
              as much as the code itself. The name references the Roman shield
              associated with protection — a reminder that the work exists to
              support awareness, decision-making, and resilience in the field.
            </p>
          </Reveal>
        </div>
      </section>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            <Reveal>
              <article className="lift-card h-full rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
                <div className="w-fit rounded-2xl bg-burnt-orange-50 p-3 text-burnt-orange-700">
